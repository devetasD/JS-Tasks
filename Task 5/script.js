...
console.log("These people are dog owners:");
filterDogOwners.forEach((filterDogOwners) => {
  console.log(filterDogOwners.name);
});

// 2.

const filterAdults = users.filter((user) => user.age >= 18);
console.log("These people are Adults:");
filterAdults.forEach((filterAdults) => {
